...
exports.FindSendTransactionController = void 0;
const http_helper_1 = require("../../../helper/http/http-helper");
class FindSendTransactionController {
    ...
    handle(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const transactions = yield this.findTransactions.findSend({ date, accountId, limit, skip });
...
exports.FindSendTransactionController = FindSendTransactionController;
