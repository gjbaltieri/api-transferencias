...
exports.FindTransactionController = void 0;
    ...
    handle(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const transactions = yield this.findTransactions.findAll({ date, accountId, limit, skip });
...
exports.FindTransactionController = FindTransactionController;
